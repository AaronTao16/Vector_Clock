...
public final class DataStore {
  ...
  public interface ConflictsOrBuilder extends
      // @@protoc_insertion_point(interface_extends:Conflicts)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>repeated .Server server = 1;</code>
     */
    java.util.List<com.rpc.DataStore.Server> 
        getServerList();
    /**
     * <code>repeated .Server server = 1;</code>
     */
    com.rpc.DataStore.Server getServer(int index);
    /**
     * <code>repeated .Server server = 1;</code>
     */
    int getServerCount();
     ...
     * <code>repeated .Server server = 1;</code>
     */
    com.rpc.DataStore.ServerOrBuilder getServerOrBuilder(
        int index);
  }
  /**
   * Protobuf type {@code Conflicts}
   */
  public  static final class Conflicts extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:Conflicts)
      ConflictsOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use Conflicts.newBuilder() to construct.
    private Conflicts(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private Conflicts() {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                server_ = new java.util.ArrayList<com.rpc.DataStore.Server>();
                mutable_bitField0_ |= 0x00000001;
              }
              server_.add(
                  input.readMessage(com.rpc.DataStore.Server.parser(), extensionRegistry));
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.rpc.DataStore.internal_static_Conflicts_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.rpc.DataStore.internal_static_Conflicts_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.rpc.DataStore.Conflicts.class, com.rpc.DataStore.Conflicts.Builder.class);
    }

    public static final int SERVER_FIELD_NUMBER = 1;
    private java.util.List<com.rpc.DataStore.Server> server_;
    /**
     * <code>repeated .Server server = 1;</code>
     */
    public java.util.List<com.rpc.DataStore.Server> getServerList() {
      return server_;
    }
    /**
     * <code>repeated .Server server = 1;</code>
     ...
     * <code>repeated .Server server = 1;</code>
     */
    public com.rpc.DataStore.Server getServer(int index) {
      return server_.get(index);
    }
    /**
     * <code>repeated .Server server = 1;</code>
     */
    public com.rpc.DataStore.ServerOrBuilder getServerOrBuilder(
        int index) {
      return server_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof com.rpc.DataStore.Conflicts)) {
        return super.equals(obj);
      }
      com.rpc.DataStore.Conflicts other = (com.rpc.DataStore.Conflicts) obj;
    ...
    public static com.rpc.DataStore.Conflicts parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static com.rpc.DataStore.Conflicts parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.rpc.DataStore.Conflicts parseFrom(
    ...
    public static com.rpc.DataStore.Conflicts parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static com.rpc.DataStore.Conflicts parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static com.rpc.DataStore.Conflicts parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(com.rpc.DataStore.Conflicts prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:Conflicts)
        com.rpc.DataStore.ConflictsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.rpc.DataStore.internal_static_Conflicts_descriptor;
      }
      ...
      // Construct using com.rpc.DataStore.Conflicts.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public com.rpc.DataStore.Conflicts getDefaultInstanceForType() {
        return com.rpc.DataStore.Conflicts.getDefaultInstance();
      }

      @java.lang.Override
      public com.rpc.DataStore.Conflicts build() {
        com.rpc.DataStore.Conflicts result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public com.rpc.DataStore.Conflicts buildPartial() {
        com.rpc.DataStore.Conflicts result = new com.rpc.DataStore.Conflicts(this);
        int from_bitField0_ = bitField0_;
        if (serverBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
            server_ = java.util.Collections.unmodifiableList(server_);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.rpc.DataStore.Conflicts) {
          return mergeFrom((com.rpc.DataStore.Conflicts)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.rpc.DataStore.Conflicts other) {
        if (other == com.rpc.DataStore.Conflicts.getDefaultInstance()) return this;
        if (serverBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.rpc.DataStore.Conflicts parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.rpc.DataStore.Conflicts) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensureServerIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          server_ = new java.util.ArrayList<com.rpc.DataStore.Server>(server_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          com.rpc.DataStore.Server, com.rpc.DataStore.Server.Builder, com.rpc.DataStore.ServerOrBuilder> serverBuilder_;
       ...
       * <code>repeated .Server server = 1;</code>
       */
      public Builder addServer(com.rpc.DataStore.Server value) {
        if (serverBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Server server = 1;</code>
       */
      public com.rpc.DataStore.Server.Builder getServerBuilder(
          int index) {
       ...
       * <code>repeated .Server server = 1;</code>
       */
      public com.rpc.DataStore.Server.Builder addServerBuilder() {
      ...
      // @@protoc_insertion_point(builder_scope:Conflicts)
    }

    // @@protoc_insertion_point(class_scope:Conflicts)
    private static final com.rpc.DataStore.Conflicts DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new com.rpc.DataStore.Conflicts();
    }

    public static com.rpc.DataStore.Conflicts getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<Conflicts>
        PARSER = new com.google.protobuf.AbstractParser<Conflicts>() {
      @java.lang.Override
      public Conflicts parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new Conflicts(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<Conflicts> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<Conflicts> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_Conflicts_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_Conflicts_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "cts\022\027\n\006server\030\001 \003(\0132\007.Server2j\n\013DataServ" +
      "ice\022\024\n\004read\022\005.Data\032\005.Data\022\036\n\nadd_update\022" +
      "\005.Data\032\007.Server0\001\022%\n\tpropagate\022\r.Vector_" +
      "clock\032\007.Server0\001B\t\n\007com.rpcb\006proto3"
    };
    ...
    internal_static_Conflicts_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Conflicts_descriptor,
